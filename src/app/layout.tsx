...
export const metadata: Metadata = {
  title: "VerifyX — Secure OTP Authentication",
  description: "End-to-End Encrypted Two-Factor OTP Verification System",
};
  ...
  return (
    ...
    >
      <body className="min-h-screen flex flex-col bg-[#07090E] text-slate-200 antialiased relative selection:bg-[#00F5D4] selection:text-black">
        {/* Animated spider web / particle mesh directly in the background */}
        <SpiderBackground />
